...
################################################################
# This is a generated script based on design: alu4
#
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xc7z030fbg484-3
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name alu4
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Ea [ create_bd_port -dir I -from 0 -to 0 Ea ]
  set S0 [ create_bd_port -dir I S0 ]
  set S1 [ create_bd_port -dir I S1 ]
  set V10H [ create_bd_port -dir O -from 0 -to 0 V10H ]
  set V11H [ create_bd_port -dir O -from 0 -to 0 V11H ]
  set V12H [ create_bd_port -dir O -from 0 -to 0 V12H ]
  set V13H [ create_bd_port -dir O -from 0 -to 0 V13H ]
  ...
  connect_bd_net -net Net [get_bd_ports S0] [get_bd_pins util_vector_logic_12/Op1] [get_bd_pins util_vector_logic_4/Op1] [get_bd_pins util_vector_logic_6/Op1]
  connect_bd_net -net Net1 [get_bd_ports S1] [get_bd_pins util_vector_logic_12/Op2] [get_bd_pins util_vector_logic_5/Op1] [get_bd_pins util_vector_logic_9/Op2]
  connect_bd_net -net Op1_0_1 [get_bd_ports Ea] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_10/Op1] [get_bd_pins util_vector_logic_13/Op1] [get_bd_pins util_vector_logic_2/Op1] [get_bd_pins util_vector_logic_7/Op1]
  connect_bd_net -net util_vector_logic_10_Res [get_bd_pins util_vector_logic_10/Res] [get_bd_pins util_vector_logic_11/Op1]
  connect_bd_net -net util_vector_logic_11_Res [get_bd_ports V12H] [get_bd_pins util_vector_logic_11/Res]
  connect_bd_net -net util_vector_logic_12_Res [get_bd_pins util_vector_logic_12/Res] [get_bd_pins util_vector_logic_13/Op2]
  connect_bd_net -net util_vector_logic_13_Res [get_bd_pins util_vector_logic_13/Res] [get_bd_pins util_vector_logic_14/Op1]
  connect_bd_net -net util_vector_logic_14_Res [get_bd_ports V13H] [get_bd_pins util_vector_logic_14/Res]
  ...
  connect_bd_net -net util_vector_logic_3_Res [get_bd_ports V10H] [get_bd_pins util_vector_logic_3/Res]
  connect_bd_net -net util_vector_logic_4_Res [get_bd_pins util_vector_logic_1/Op1] [get_bd_pins util_vector_logic_4/Res] [get_bd_pins util_vector_logic_9/Op1]
  connect_bd_net -net util_vector_logic_5_Res [get_bd_pins util_vector_logic_1/Op2] [get_bd_pins util_vector_logic_5/Res] [get_bd_pins util_vector_logic_6/Op2]
  connect_bd_net -net util_vector_logic_6_Res [get_bd_pins util_vector_logic_6/Res] [get_bd_pins util_vector_logic_7/Op2]
  connect_bd_net -net util_vector_logic_7_Res [get_bd_pins util_vector_logic_7/Res] [get_bd_pins util_vector_logic_8/Op1]
  connect_bd_net -net util_vector_logic_8_Res [get_bd_ports V11H] [get_bd_pins util_vector_logic_8/Res]
