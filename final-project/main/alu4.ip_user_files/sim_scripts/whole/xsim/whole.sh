...
elaborate()
{
  xelab --relax --debug typical --mt auto -L util_vector_logic_v2_0_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot whole xil_defaultlib.whole xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim whole -key {Behavioral:sim_1:Functional:whole} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Vivado/2018.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb whole.wdb xsim.dir)
