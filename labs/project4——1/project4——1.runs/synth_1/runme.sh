...
HD_PWD='C:/Users/dell/project4！！1/project4！！1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log select.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source select.tcl
